package com.yto.tech.catplugin.mybatis;
...
public class CatMybatisPlugin implements Interceptor {
  ...
  private static final String MYSQL_DEFAULT_URL = "jdbc:mysql://defaultHost:3306/%s?useUnicode=true";
  private Executor target;

  @Override
  public Object intercept(Invocation invocation) throws Throwable {
    logger.debug("cat mybatis plugin invoked.....");
  ...
  private String switchDataSource(DataSource dataSource) throws NoSuchFieldException, IllegalAccessException {
    String url = dataSource.getClass().getName();
